        ...
        <div className="min-h-screen bg-muted/30 pb-20">
            <header className="bg-background border-b h-16 flex items-center px-6 sticky top-0 z-50">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xl">MEPROCENT <span className="text-xs font-normal text-muted-foreground">| Certificaciones</span></span>
                </div>
            </header>
            <main className="max-w-4xl mx-auto p-4 pt-8">
                ...
                <PestControlDossier intervencion={{ ...intervencion, id } as Intervencion & { id: string }} />
            </main>
        </div>
    );
}
