...
export default function FumigacionIntervencionesPage({ searchParams }: { searchParams?: { status?: string } }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Intervenciones de Fumigación</h1>
          <p className="text-muted-foreground">
            Servicios de fumigación y control de plagas en trampas y cebaderas.
          </p>
        </div>
        <Button asChild>
          <Link href="/fumigacion/intervenciones/new">
      ...
      {loading ? (
        ...
        <InterventionsTable intervenciones={intervenciones} basePath="/fumigacion/intervenciones" />
      )}
    </div>
  );
}
