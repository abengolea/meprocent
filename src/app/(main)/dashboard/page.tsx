...
import { getAlarms, getEquipos, getIntervenciones } from "@/lib/mock-data";
        ...
        <div className="flex flex-col gap-6">
            <header>
                ...
                <p className="text-muted-foreground">
                    Un resumen del estado actual de sus equipos y mantenimientos.
                </p>
            </header>
...
async function StatsCardsLoader() {
    ...
    return <StatsCards equipos={equipos} alarmas={alarmas} intervenciones={intervenciones} />;
}
